...
for i in range(m):
    set_2.add(int(input()))
# Находим пересечение множеств и выводим его отсортированным списком
intersection = sorted(list(set_1 & set_2))
print("Числа, которые встречаются в обоих множествах:", intersection)
"""
